"""Module that contains functions which test the merge_sort function."""
import pytest
...
@pytest.mark.parametrize('bad_input', [
                                       ...
                                       {'a': 5},
                                       {1, 2, 3}])
def test_merge_sort_raises_valueerror_if_input_not_list_type(bad_input):
    """Function that tests the merge_sort function will raise a ValueError if
    the given input is not a list."""

    assert isinstance(bad_input, list) is False
    with pytest.raises(ValueError):
        assert merge_sort(bad_input)
...
def test_merge_sort_return_sorted_list_float(lst_input, output):
    """Function that tests the merge_sort function returns the list with the
...
def test_merge_sort_return_sorted_list_string(lst_input, output):
    """Function that tests the merge_sort function returns the list with the
...
def test_merge_sort_raises_valueerror_if_given_list_contains_set():
    """Function that tests the merge_sort function will raise a ValueError if
    given a list that contains a set."""

    with pytest.raises(ValueError):
        assert merge_sort([{1, 2, 3}])


def test_merge_sort_raises_valueerror_if_given_list_contains_list():
    """Function that tests the merge_sort function will raise a ValueError if
...
def test_merge_sort_raises_valueerror_if_given_list_contains_dictionary():
    """Function that tests the merge_sort function will raise a ValueError if
    given a list that contains a dictionary."""

    with pytest.raises(ValueError):
        assert merge_sort([{'a': 1}])


def test_merge_sort_raises_valueerror_if_given_list_contains_tuple():
    """Function that tests the merge_sort function will raise a ValueError if
...
def test_merge_sort_return_list_if_length_less_than_equal_to_one():
    """Function that tests the merge_sort function will return the given list
    without alterations if the initial input is a list with a length less than
    or equal to one."""
